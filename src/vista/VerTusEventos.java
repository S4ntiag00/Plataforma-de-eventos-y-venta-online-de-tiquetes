...
public class VerTusEventos extends javax.swing.JFrame {
    ...
    private void mostrarDetallesEvento(Evento evento) {
        if (evento != null) {
            ModificarEvento modificarEvento = new ModificarEvento(evento.getIdEvento());
            modificarEvento.setVisible(true);
             modificarEvento.txt_nombreEvento.setText(evento.getNombreEvento());
             modificarEvento.txt_descripcionEvento.setText(evento.getDescripcionEvento());
             modificarEvento.txt_fecha.setText(evento.getFecha());
             modificarEvento.txt_hora.setText(evento.getHora());
             modificarEvento.txt_direccion.setText(evento.getDireccion());
             modificarEvento.labelPoster.setText(Arrays.toString(evento.getPoster()));
